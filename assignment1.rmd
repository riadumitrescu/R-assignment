...
```
Median BMI in group 0 was ~41.8, with most values between ~37.8 and 43.8. Group 0 is more spread out than Group 1 because the BMI values cover a wider range (IQR ≈ 6 vs. 2.5). This means that BMIs among females in Group 0 were more variable, while those in Group 1 were more consistent and clustered around the median. 
```{r}
# simple boxplot
...
This project looked at the *laryngoscope* dataset, which tracks patients in a study comparing video versus direct laryngoscopy. There are 99 patients total: 78 men (coded as 0) and 21 women (coded as 1).  
...
Overall, the results show that most younger female patients had an easy intubation, and there wasn’t much difference in BMI between the two treatment groups.  
